...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      <Container maxW="7xl" pt={28} pb={20} position="relative" zIndex={2}>
  ...
  Powered by 3 advanced AI models working seamlessly for your mind, body, and soul.
        ...
        {/*  Features */}
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8} mt={24}>
          <FeatureCard icon={<FaHeart />} title="Emotional Support (Supportive Coach)" desc="Stay calm, supported, and productive with empathetic advice." />
          <FeatureCard icon={<FaDumbbell />} title="Fitness Coaching (Gym Trainer)" desc="Get tough love motivation and personalized workout tips." />
          <FeatureCard icon={<FaSpa />} title="Mindfulness Mentor (Meditation Guru)" desc="Relax your mind and reconnect through mindfulness practices." />
        </SimpleGrid>
      </Container>
...
function FeatureCard({ icon, title, desc }) {
  return (
    ...
    >
      ...
      <Text fontSize="sm" color="gray.300">{desc}</Text>
    </VStack>
  );
}
